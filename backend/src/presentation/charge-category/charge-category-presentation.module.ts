...
import { DeleteChargeCategoryController } from './controllers/delete-charge-category.controller.js';
...
@Module({
  ...
  controllers: [GetChargeCategoriesController, CreateChargeCategoryController, DeleteChargeCategoryController],
